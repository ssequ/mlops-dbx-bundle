...
git add README.md docs .gitignore mlops_dbx_bundle/resources/README.md
...
* You must be a Databricks workspace admin in the staging and prod workspaces. 
  ...
  [staging workspace admin console](https://adb-3456846349234988.8.azuredatabricks.net#setting/accounts) and
  [prod workspace admin console](https://adb-3456846349234988.8.azuredatabricks.net#setting/accounts). 
...
If you want to use different catalog names, please update the target names declared in the[mlops-dbx-bundle/databricks.yml](../mlops_dbx_bundle/databricks.yml) file.
...
Follow the instructions in [mlops-dbx-bundle/resources/README.md](../mlops_dbx_bundle/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../mlops_dbx_bundle/resources/README.md)  to propose, test, and deploy
