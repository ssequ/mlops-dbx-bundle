...
Opening a pull request will trigger a[workflow](../.github/workflows/mlops-dbx-bundle-run-tests.yml) 
...
Links:
* [Staging model in UC](https://adb-3456846349234988.8.azuredatabricks.net/explore/data/models/staging/mlops-dbx-bundle/mlops-dbx-bundle-model)
* [Prod model in UC](https://adb-3456846349234988.8.azuredatabricks.net/explore/data/models/prod/mlops-dbx-bundle/mlops-dbx-bundle-model)
. 
