...
# ``mlops_dbx_bundle/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-mlops-dbx-bundle-experiment",
...
dbutils.widgets.text(
    "model_name", "dev.mlops_dbx_bundle.mlops-dbx-bundle-model", label="Full (Three-Level) Model Name"
)

# Pickup features table name
dbutils.widgets.text(
    "pickup_features_table",
    "dev.mlops_dbx_bundle.trip_pickup_features",
...
dbutils.widgets.text(
    ...
    "dev.mlops_dbx_bundle.trip_dropoff_features",
